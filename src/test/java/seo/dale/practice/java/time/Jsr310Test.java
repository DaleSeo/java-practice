...
public class Jsr310Test {
    ...
    public void shouldGetAfterOneHour() {
        ...
        assertThat(after1Hour.format(formatter)).isEqualTo("1988.05.08 00:00");
    }

    @Test
    public void shouldAfterOneMinute() {
        ZoneId seoul = ZoneId.of("Asia/Seoul");
    ...
    @Test
    public void shouldGetAfterTwoSeconds() {
        ...
        ZonedDateTime after1Minute = theTime.plusSeconds(2);
        assertThat(after1Minute.format(formatter)).isEqualTo("2012.07.01 00:00:01");
    }
